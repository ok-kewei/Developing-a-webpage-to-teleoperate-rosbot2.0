...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'husky_highlevel_controller/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'husky_highlevel_controller/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'husky_highlevel_controller/AddTwoInts'; }
};
