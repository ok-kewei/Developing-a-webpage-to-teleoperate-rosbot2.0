...
echo_and_run cd "/home/kewei/catkin_ws_web/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kewei/catkin_ws_web/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/kewei/catkin_ws_web/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
