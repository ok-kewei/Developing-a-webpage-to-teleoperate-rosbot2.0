...
echo_and_run cd "/home/kewei/catkin_ws_web/src/rosbridge_suite/rosbridge_server"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kewei/catkin_ws_web/src/rosbridge_suite/rosbridge_server/setup.py" \
     \
    build --build-base "/home/kewei/catkin_ws_web/build/rosbridge_suite/rosbridge_server" \
    install \
    --root="${DESTDIR-/}" \
